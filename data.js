...
// Top 5 zonales con más altas, por mes y por gerencia ("total" = todas las gerencias de la marca ese mes).
// Se usa para el chart dinámico de Top 5 Zonales según el filtro de mes/gerencia activo.
window.ZONALES_TOP5 = {
  sabores: {
    may25: {
      "total": [{ x:"Michelle Alvarez", y:24 }, { x:"Malena Aguera", y:22 }, { x:"Maria Gomez", y:21 }, { x:"Veronica Gonzalez", y:17 }, { x:"Tamara Migoya", y:15 }],
      "Marcelo Biurra": [{ x:"Malena Aguera", y:22 }, { x:"Veronica Gonzalez", y:17 }, { x:"Renata Fedullo", y:14 }, { x:"Aylen Ponce", y:12 }, { x:"Sofia D´antuono", y:11 }],
      "Gustavo Cabrera": [{ x:"Maria Gomez", y:21 }, { x:"Gabriel Rios", y:13 }, { x:"Camila Almeida", y:11 }, { x:"Marianella Yñiguez", y:10 }, { x:"Douglas Seprum", y:8 }],
      "Agustín Sbampato": [],
      "Lucas Piarristeguy": [{ x:"Greisnell Mejias", y:11 }, { x:"Lujan Brandan", y:10 }, { x:"Isabel Leal", y:9 }, { x:"Magali Sandoval", y:5 }, { x:"Adriana Alvarez", y:5 }],
      "Federico Morales": [{ x:"Michelle Alvarez", y:24 }, { x:"Tamara Migoya", y:15 }, { x:"Emanuel Mazueco", y:11 }, { x:"Brandon Oliva", y:9 }, { x:"Luciana Bianco", y:8 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [{ x:"Cecilia Montoya", y:13 }, { x:"Micaela Ponce", y:9 }],
    },
    jun25: {
      "total": [{ x:"Michelle Alvarez", y:15 }, { x:"Micaela Ponce", y:13 }, { x:"Camila Almeida", y:13 }, { x:"Pablo Muga", y:12 }, { x:"Tamara Migoya", y:9 }],
      "Marcelo Biurra": [{ x:"Renata Fedullo", y:7 }, { x:"Aylen Ponce", y:7 }, { x:"Veronica Gonzalez", y:6 }, { x:"Sofia D´antuono", y:4 }, { x:"Pamela Maidana", y:4 }],
      "Gustavo Cabrera": [{ x:"Camila Almeida", y:13 }, { x:"Maria Gomez", y:8 }, { x:"Gabriel Rios", y:7 }, { x:"Douglas Seprum", y:4 }, { x:"Marianella Yñiguez", y:1 }],
      "Agustín Sbampato": [],
      "Lucas Piarristeguy": [{ x:"Greisnell Mejias", y:9 }, { x:"Franco Pedraza", y:9 }, { x:"Adriana Alvarez", y:9 }, { x:"Magali Sandoval", y:7 }, { x:"Lujan Brandan", y:7 }],
      "Federico Morales": [{ x:"Michelle Alvarez", y:15 }, { x:"Pablo Muga", y:12 }, { x:"Tamara Migoya", y:9 }, { x:"Brandon Oliva", y:8 }, { x:"Emanuel Mazueco", y:7 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [{ x:"Micaela Ponce", y:13 }, { x:"Cecilia Montoya", y:5 }],
    },
    jul25: {
      "total": [{ x:"Marianella Yñiguez", y:25 }, { x:"Camila Almeida", y:16 }, { x:"Luciana Bianco", y:15 }, { x:"Natalia Giorgi", y:14 }, { x:"Micaela Ponce", y:13 }],
      "Marcelo Biurra": [{ x:"Sofia D´antuono", y:13 }, { x:"Pamela Maidana", y:8 }, { x:"Malena Aguera", y:8 }, { x:"Aylen Ponce", y:8 }, { x:"Veronica Gonzalez", y:7 }],
      ...
      "Agustín Sbampato": [],
      "Lucas Piarristeguy": [{ x:"Natalia Giorgi", y:14 }, { x:"Adriana Alvarez", y:12 }, { x:"Lujan Brandan", y:10 }, { x:"Isabel Leal", y:8 }, { x:"Greisnell Mejias", y:7 }],
      "Federico Morales": [{ x:"Luciana Bianco", y:15 }, { x:"Emanuel Mazueco", y:12 }, { x:"Brandon Oliva", y:12 }, { x:"Michelle Alvarez", y:8 }, { x:"Tamara Migoya", y:7 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [{ x:"Micaela Ponce", y:13 }, { x:"Cecilia Montoya", y:8 }],
    },
    ago25: {
      "total": [{ x:"Douglas Seprum", y:19 }, { x:"Malena Aguera", y:19 }, { x:"Marianella Yñiguez", y:18 }, { x:"Natalia Giorgi", y:13 }, { x:"Veronica Gonzalez", y:13 }],
      "Marcelo Biurra": [{ x:"Malena Aguera", y:19 }, { x:"Veronica Gonzalez", y:13 }, { x:"Renata Fedullo", y:11 }, { x:"Sofia D´antuono", y:7 }, { x:"Pamela Maidana", y:5 }],
      ...
      "Agustín Sbampato": [],
      "Lucas Piarristeguy": [{ x:"Natalia Giorgi", y:13 }, { x:"Adriana Alvarez", y:11 }, { x:"Lujan Brandan", y:9 }, { x:"Greisnell Mejias", y:7 }, { x:"Magali Sandoval", y:5 }],
      "Federico Morales": [{ x:"Luciana Bianco", y:10 }, { x:"Michelle Alvarez", y:9 }, { x:"Emanuel Mazueco", y:8 }, { x:"Brandon Oliva", y:8 }, { x:"Tamara Migoya", y:8 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [{ x:"Micaela Ponce", y:10 }, { x:"Cecilia Montoya", y:4 }],
    },
    sep25: {
      "total": [{ x:"Tamara Migoya", y:22 }, { x:"Isabel Leal", y:20 }, { x:"Lujan Brandan", y:18 }, { x:"Veronica Gonzalez", y:18 }, { x:"Camila Almeida", y:17 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:18 }, { x:"Aylen Ponce", y:15 }, { x:"Malena Aguera", y:13 }, { x:"Renata Fedullo", y:12 }, { x:"Sofia D´antuono", y:4 }],
      ...
      "Lucas Piarristeguy": [{ x:"Lujan Brandan", y:18 }, { x:"Isabel Leal", y:17 }, { x:"Magali Sandoval", y:10 }, { x:"Greisnell Mejias", y:9 }, { x:"Franco Pedraza", y:9 }],
      "Federico Morales": [{ x:"Tamara Migoya", y:22 }, { x:"Luciana Bianco", y:13 }, { x:"Emanuel Mazueco", y:8 }, { x:"Brandon Oliva", y:8 }, { x:"Michelle Alvarez", y:5 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [{ x:"Cecilia Montoya", y:7 }, { x:"Micaela Ponce", y:4 }],
    },
    oct25: {
      "total": [{ x:"Maria Gomez", y:23 }, { x:"Camila Fredes", y:22 }, { x:"Veronica Gonzalez", y:21 }, { x:"Natalia Giorgi", y:17 }, { x:"Tamara Migoya", y:13 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:21 }, { x:"Aylen Ponce", y:11 }, { x:"Micaela Ponce", y:6 }, { x:"Sofia D´antuono", y:3 }, { x:"Pablo Figueroa", y:1 }],
      ...
      "Lucas Piarristeguy": [{ x:"Natalia Giorgi", y:17 }, { x:"Lujan Brandan", y:11 }, { x:"Magali Sandoval", y:7 }, { x:"Greisnell Mejias", y:4 }, { x:"Isabel Leal", y:3 }],
      "Federico Morales": [{ x:"Brandon Oliva", y:9 }, { x:"Isabel Leal", y:5 }, { x:"Luciana Bianco", y:5 }, { x:"Pablo Muga", y:5 }, { x:"Emanuel Mazueco", y:2 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [],
    ...
    nov25: {
      "total": [{ x:"Isabel Leal", y:22 }, { x:"Renata Fedullo", y:12 }, { x:"Brian Melo", y:12 }, { x:"Aylen Ponce", y:9 }, { x:"Natalia Giorgi", y:8 }],
      "Marcelo Biurra": [{ x:"Aylen Ponce", y:9 }, { x:"Malena Aguera", y:7 }, { x:"Sofia D´antuono", y:4 }, { x:"Veronica Gonzalez", y:3 }, { x:"Micaela Ponce", y:1 }],
      "Gustavo Cabrera": [{ x:"Camila Fredes", y:8 }, { x:"Marianella Yñiguez", y:5 }, { x:"Camila Almeida", y:5 }, { x:"Maria Gomez", y:4 }, { x:"Micaela Ponce", y:1 }],
      "Agustín Sbampato": [{ x:"Renata Fedullo", y:12 }, { x:"Ronaldo Arguello", y:7 }, { x:"Brandon Oliva", y:6 }, { x:"Tamara Migoya", y:5 }],
      "Lucas Piarristeguy": [{ x:"Natalia Giorgi", y:8 }, { x:"Lujan Brandan", y:6 }, { x:"Franco Pedraza", y:4 }, { x:"Greisnell Mejias", y:3 }, { x:"Magali Sandoval", y:3 }],
      "Federico Morales": [{ x:"Isabel Leal", y:20 }, { x:"Brian Melo", y:12 }, { x:"Luciana Bianco", y:2 }, { x:"Emanuel Mazueco", y:2 }, { x:"Pablo Muga", y:2 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [],
    ...
    dic25: {
      "total": [{ x:"Lujan Brandan", y:39 }, { x:"Ronaldo Arguello", y:28 }, { x:"Camila Almeida", y:27 }, { x:"Brian Melo", y:26 }, { x:"Michelle Alvarez", y:18 }],
      "Marcelo Biurra": [{ x:"Sofia D´antuono", y:14 }, { x:"Veronica Gonzalez", y:8 }, { x:"Pamela Maidana", y:8 }, { x:"Pablo Figueroa", y:8 }, { x:"Malena Aguera", y:4 }],
      ...
      "Agustín Sbampato": [{ x:"Ronaldo Arguello", y:28 }, { x:"Michelle Alvarez", y:18 }, { x:"Tamara Migoya", y:16 }, { x:"Brandon Oliva", y:13 }, { x:"Renata Fedullo", y:2 }],
      "Lucas Piarristeguy": [{ x:"Lujan Brandan", y:39 }, { x:"Franco Pedraza", y:15 }, { x:"Natalia Giorgi", y:12 }, { x:"Adriana Alvarez", y:8 }, { x:"Magali Sandoval", y:6 }],
      "Federico Morales": [{ x:"Brian Melo", y:25 }, { x:"Isabel Leal", y:13 }, { x:"Emanuel Mazueco", y:12 }, { x:"Ezequiel Acosta", y:4 }, { x:"Gabriela Ferreyra", y:4 }],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [],
      "Eliana Miguez": [],
    ...
    ene26: {
      "total": [{ x:"Veronica Gonzalez", y:32 }, { x:"Camila Almeida", y:28 }, { x:"Lujan Brandan", y:22 }, { x:"Michelle Alvarez", y:17 }, { x:"Pamela Maidana", y:16 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:32 }, { x:"Camila Almeida", y:24 }, { x:"Renata Fedullo", y:12 }, { x:"Giovanna Solerez", y:12 }, { x:"Ronaldo Arguello", y:8 }],
      "Gustavo Cabrera": [{ x:"Marianella Yñiguez", y:16 }, { x:"Pamela Maidana", y:12 }, { x:"Brandon Oliva", y:11 }, { x:"Camila Fredes", y:10 }, { x:"Maria Gomez", y:7 }],
      "Agustín Sbampato": [{ x:"Michelle Alvarez", y:17 }, { x:"Lujan Brandan", y:10 }, { x:"Camila Carranza", y:9 }, { x:"Magali Sandoval", y:3 }, { x:"Tamara Migoya", y:2 }],
      "Lucas Piarristeguy": [{ x:"Lujan Brandan", y:12 }, { x:"Greisnell Mejias", y:2 }, { x:"Franco Pedraza", y:1 }, { x:"Natalia Giorgi", y:1 }],
      "Federico Morales": [{ x:"Brian Melo", y:3 }, { x:"Emanuel Mazueco", y:1 }, { x:"Pablo Muga", y:1 }, { x:"Isabel Leal", y:1 }],
      "Mauro Dala Valle": [{ x:"Douglas Seprum", y:9 }, { x:"Greisnell Mejias", y:5 }, { x:"Maria Gomez", y:4 }, { x:"Emanuel Mazueco", y:2 }, { x:"Ezequiel Acosta", y:2 }],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [{ x:"Pablo Figueroa", y:10 }, { x:"Pamela Maidana", y:3 }, { x:"Renata Fedullo", y:3 }, { x:"Pablo Muga", y:2 }, { x:"Malena Aguera", y:2 }],
      "Eliana Miguez": [],
    },
    feb26: {
      "total": [{ x:"Greisnell Mejias", y:26 }, { x:"Michelle Alvarez", y:25 }, { x:"Veronica Gonzalez", y:24 }, { x:"Ezequiel Acosta", y:15 }, { x:"Emanuel Mazueco", y:14 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:24 }, { x:"Ronaldo Arguello", y:14 }, { x:"Camila Almeida", y:13 }, { x:"Nahuel Sanchez", y:5 }, { x:"Sofia D´antuono", y:4 }],
      ...
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [{ x:"Greisnell Mejias", y:26 }, { x:"Ezequiel Acosta", y:15 }, { x:"Emanuel Mazueco", y:12 }, { x:"Maria Gomez", y:4 }, { x:"Gabriela Ferreyra", y:1 }],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [{ x:"Renata Fedullo", y:10 }, { x:"Malena Aguera", y:4 }, { x:"Pablo Muga", y:3 }, { x:"Pablo Figueroa", y:1 }],
      "Eliana Miguez": [],
    },
    mar26: {
      "total": [{ x:"Michelle Alvarez", y:33 }, { x:"Ezequiel Acosta", y:28 }, { x:"Maria Gomez", y:27 }, { x:"Nahuel Sanchez", y:24 }, { x:"Pamela Maidana", y:22 }],
      ...
      "Agustín Sbampato": [{ x:"Michelle Alvarez", y:32 }, { x:"Lujan Brandan", y:14 }, { x:"Tomas Moreno", y:13 }, { x:"Magali Sandoval", y:5 }, { x:"Franco Pedraza", y:5 }],
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [{ x:"Ezequiel Acosta", y:28 }, { x:"Maria Gomez", y:27 }, { x:"Emanuel Mazueco", y:18 }, { x:"Gabriela Ferreyra", y:17 }, { x:"Greisnell Mejias", y:11 }],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [{ x:"Renata Fedullo", y:12 }, { x:"Pablo Muga", y:10 }, { x:"Pablo Figueroa", y:9 }, { x:"Malena Aguera", y:8 }, { x:"Nahuel Sanchez", y:4 }],
      "Eliana Miguez": [],
    },
    abr26: {
      "total": [{ x:"Michelle Alvarez", y:24 }, { x:"Magali Sandoval", y:22 }, { x:"Veronica Gonzalez", y:22 }, { x:"Tamara Migoya", y:16 }, { x:"Camila Almeida", y:16 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:22 }, { x:"Camila Almeida", y:16 }, { x:"Sofia D´antuono", y:11 }, { x:"Ronaldo Arguello", y:9 }, { x:"Giovanna Solerez", y:9 }],
      "Gustavo Cabrera": [{ x:"Tamara Migoya", y:16 }, { x:"Camila Fredes", y:8 }, { x:"Pamela Maidana", y:8 }, { x:"Marianella Yñiguez", y:7 }, { x:"Agustina Sussi", y:4 }],
      "Agustín Sbampato": [{ x:"Michelle Alvarez", y:24 }, { x:"Magali Sandoval", y:22 }, { x:"Tomas Moreno", y:14 }, { x:"Camila Carranza", y:13 }, { x:"Lujan Brandan", y:4 }],
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [{ x:"Ezequiel Acosta", y:15 }, { x:"Greisnell Mejias", y:15 }, { x:"Gabriela Ferreyra", y:14 }, { x:"Maria Gomez", y:13 }, { x:"Luciana Bianco", y:10 }],
      "Ivo Pisaniello": [],
      "Lucía Vélez": [{ x:"Renata Fedullo", y:12 }, { x:"Pablo Muga", y:12 }, { x:"Malena Aguera", y:3 }, { x:"Nahuel Sanchez", y:2 }],
      "Eliana Miguez": [],
    },
    may26: {
      "total": [{ x:"Douglas Seprum", y:25 }, { x:"Ronaldo Arguello", y:21 }, { x:"Magali Sandoval", y:18 }, { x:"Michelle Alvarez", y:17 }, { x:"Greisnell Mejias", y:17 }],
      "Marcelo Biurra": [{ x:"Ronaldo Arguello", y:21 }, { x:"Veronica Gonzalez", y:16 }, { x:"Camila Almeida", y:11 }, { x:"Aylen Ponce", y:8 }, { x:"Sofia D´antuono", y:8 }],
      "Gustavo Cabrera": [{ x:"Pamela Maidana", y:13 }, { x:"Marianella Yñiguez", y:11 }, { x:"Agustina Sussi", y:9 }, { x:"Cecilia Montoya", y:6 }, { x:"Tamara Migoya", y:5 }],
      "Agustín Sbampato": [{ x:"Magali Sandoval", y:18 }, { x:"Michelle Alvarez", y:17 }, { x:"Camila Carranza", y:15 }, { x:"Adriana Alvarez", y:3 }, { x:"Lujan Brandan", y:3 }],
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [{ x:"Gabriela Ferreyra", y:9 }, { x:"Greisnell Mejias", y:8 }, { x:"Ezequiel Acosta", y:5 }, { x:"Douglas Seprum", y:4 }],
      "Ivo Pisaniello": [{ x:"Douglas Seprum", y:21 }, { x:"Ariana Gomez", y:14 }, { x:"Ezequiel Acosta", y:11 }, { x:"Greisnell Mejias", y:9 }, { x:"Emanuel Mazueco", y:8 }],
      "Lucía Vélez": [{ x:"Renata Fedullo", y:9 }, { x:"Pablo Muga", y:5 }, { x:"Nahuel Sanchez", y:4 }, { x:"Malena Aguera", y:1 }],
      "Eliana Miguez": [],
    },
    jun26: {
      "total": [{ x:"Michelle Alvarez", y:22 }, { x:"Douglas Seprum", y:18 }, { x:"Magali Sandoval", y:17 }, { x:"Emanuel Mazueco", y:15 }, { x:"Greisnell Mejias", y:15 }],
      "Marcelo Biurra": [{ x:"Veronica Gonzalez", y:11 }, { x:"Giovanna Solerez", y:10 }, { x:"Ronaldo Arguello", y:6 }, { x:"Micaela Ponce", y:4 }, { x:"Camila Almeida", y:4 }],
      "Gustavo Cabrera": [{ x:"Pamela Maidana", y:9 }, { x:"Tamara Migoya", y:6 }, { x:"Marianella Yñiguez", y:5 }, { x:"Melanie Pueblas", y:5 }, { x:"Camila Fredes", y:3 }],
      "Agustín Sbampato": [{ x:"Michelle Alvarez", y:22 }, { x:"Magali Sandoval", y:16 }, { x:"Adriana Alvarez", y:11 }, { x:"Camila Carranza", y:5 }, { x:"Lujan Brandan", y:5 }],
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [{ x:"Douglas Seprum", y:18 }, { x:"Emanuel Mazueco", y:15 }, { x:"Greisnell Mejias", y:15 }, { x:"Ezequiel Acosta", y:11 }, { x:"Ariana Gomez", y:8 }],
      "Lucía Vélez": [{ x:"Nahuel Sanchez", y:9 }, { x:"Malena Aguera", y:9 }, { x:"Renata Fedullo", y:6 }, { x:"Pablo Muga", y:5 }, { x:"Magali Sandoval", y:1 }],
      "Eliana Miguez": [],
    },
    jul26: {
      "total": [{ x:"Tomas Moreno", y:22 }, { x:"Ezequiel Acosta", y:18 }, { x:"Greisnell Mejias", y:18 }, { x:"Camila Almeida", y:14 }, { x:"Ronaldo Arguello", y:13 }],
      "Marcelo Biurra": [{ x:"Camila Almeida", y:14 }, { x:"Ronaldo Arguello", y:13 }, { x:"Veronica Gonzalez", y:6 }, { x:"Giovanna Solerez", y:6 }, { x:"Micaela Ponce", y:4 }],
      "Gustavo Cabrera": [{ x:"Pamela Maidana", y:7 }, { x:"Camila Fredes", y:6 }, { x:"Melanie Pueblas", y:5 }, { x:"Tamara Migoya", y:4 }, { x:"Marianella Yñiguez", y:3 }],
      "Agustín Sbampato": [{ x:"Magali Sandoval", y:8 }, { x:"Michelle Alvarez", y:5 }, { x:"Lujan Brandan", y:4 }, { x:"Adriana Alvarez", y:3 }, { x:"Franco Pedraza", y:3 }],
      "Lucas Piarristeguy": [],
      "Federico Morales": [],
      "Mauro Dala Valle": [],
      "Ivo Pisaniello": [{ x:"Tomas Moreno", y:22 }, { x:"Ezequiel Acosta", y:18 }, { x:"Greisnell Mejias", y:18 }, { x:"Emanuel Mazueco", y:7 }, { x:"Ariana Gomez", y:5 }],
  ...
  extremas: {
    may25: {
      "total": [{ x:"Yamila Lugo", y:7 }, { x:"Adriana Ibarra", y:7 }, { x:"Salome Rodriguez", y:6 }, { x:"Mariano Artigue", y:6 }, { x:"Marisol Ayala", y:6 }],
    ...
    jun25: {
      "total": [{ x:"Fernando Buosi", y:20 }, { x:"Yamila Lugo", y:19 }, { x:"Juan Pereyra", y:17 }, { x:"Adriana Ibarra", y:16 }, { x:"Kevin Zarate", y:11 }],
      "Facundo Aramburo": [{ x:"Yamila Lugo", y:19 }, { x:"Adriana Ibarra", y:16 }, { x:"Kevin Zarate", y:11 }, { x:"Salome Rodriguez", y:10 }, { x:"Monica Batista", y:8 }],
      "Federico Gómez": [{ x:"Fernando Buosi", y:20 }, { x:"Juan Pereyra", y:17 }, { x:"Marisol Ayala", y:10 }, { x:"Gustavo Gomez", y:8 }, { x:"Mariano Artigue", y:3 }],
      "Gustavo Gómez": [],
    },
    jul25: {
      "total": [{ x:"Mariano Artigue", y:37 }, { x:"Yamila Lugo", y:36 }, { x:"Monica Batista", y:28 }, { x:"Marisol Ayala", y:26 }, { x:"Adriana Ibarra", y:22 }],
      "Facundo Aramburo": [{ x:"Yamila Lugo", y:36 }, { x:"Monica Batista", y:28 }, { x:"Adriana Ibarra", y:22 }, { x:"Kevin Zarate", y:14 }, { x:"Salome Rodriguez", y:12 }],
      "Federico Gómez": [{ x:"Mariano Artigue", y:37 }, { x:"Marisol Ayala", y:26 }, { x:"Juan Pereyra", y:15 }, { x:"Fernando Buosi", y:8 }, { x:"Gustavo Gomez", y:7 }],
      "Gustavo Gómez": [],
    },
    ago25: {
      "total": [{ x:"Monica Batista", y:36 }, { x:"Juan Pereyra", y:35 }, { x:"Adriana Ibarra", y:34 }, { x:"Yamila Lugo", y:27 }, { x:"Mariano Artigue", y:26 }],
    ...
    sep25: {
      "total": [{ x:"Fernando Buosi", y:40 }, { x:"Monica Batista", y:23 }, { x:"Adriana Ibarra", y:21 }, { x:"Salome Rodriguez", y:20 }, { x:"Gustavo Gomez", y:18 }],
      ...
      "Federico Gómez": [{ x:"Fernando Buosi", y:40 }, { x:"Gustavo Gomez", y:18 }, { x:"Juan Pereyra", y:13 }, { x:"Mariano Artigue", y:8 }, { x:"Facundo Gimenez", y:5 }],
      "Gustavo Gómez": [],
    },
    oct25: {
      "total": [{ x:"Monica Batista", y:20 }, { x:"Kevin Zarate", y:19 }, { x:"Adriana Ibarra", y:7 }, { x:"Juan Pereyra", y:4 }, { x:"Salome Rodriguez", y:3 }],
    ...
    dic25: {
      "total": [{ x:"Adriana Ibarra", y:89 }, { x:"Yamila Lugo", y:63 }, { x:"Kevin Zarate", y:52 }, { x:"Monica Batista", y:45 }, { x:"Roxana Gorosito", y:40 }],
      ...
      "Federico Gómez": [{ x:"Juan Pereyra", y:20 }, { x:"Jaquelina Polo", y:18 }, { x:"Mariano Artigue", y:14 }, { x:"Facundo Gimenez", y:12 }, { x:"Fernando Buosi", y:9 }],
      "Gustavo Gómez": [{ x:"Roxana Gorosito", y:36 }, { x:"Monica Batista", y:17 }, { x:"Jaquelina Polo", y:6 }],
    },
    ene26: {
      "total": [{ x:"Adriana Ibarra", y:42 }, { x:"Salome Rodriguez", y:37 }, { x:"Roxana Gorosito", y:36 }, { x:"Mariano Artigue", y:27 }, { x:"Fernando Buosi", y:19 }],
    ...
    feb26: {
      "total": [{ x:"Salome Rodriguez", y:47 }, { x:"Yamila Lugo", y:26 }, { x:"Monica Batista", y:15 }, { x:"Juan Pereyra", y:13 }, { x:"Mayra Agmatt", y:12 }],
    ...
    mar26: {
      "total": [{ x:"Roxana Gorosito", y:64 }, { x:"Salome Rodriguez", y:40 }, { x:"Fernando Buosi", y:39 }, { x:"Monica Batista", y:31 }, { x:"Mayra Agmatt", y:29 }],
    ...
    abr26: {
      "total": [{ x:"Mayra Agmatt", y:32 }, { x:"Salome Rodriguez", y:24 }, { x:"Monica Batista", y:22 }, { x:"Fernando Buosi", y:21 }, { x:"Roxana Gorosito", y:20 }],
    ...
    may26: {
      ...
      "Federico Gómez": [{ x:"Fernando Buosi", y:24 }, { x:"Jaquelina Polo", y:23 }, { x:"Facundo Gimenez", y:13 }, { x:"Juan Pereyra", y:8 }, { x:"Mariano Artigue", y:4 }],
      "Gustavo Gómez": [{ x:"Roxana Gorosito", y:22 }, { x:"Lautaro Tesi", y:10 }, { x:"Monica Batista", y:4 }, { x:"Salome Rodriguez", y:1 }],
    },
    jun26: {
      "total": [{ x:"Mariano Artigue", y:33 }, { x:"Monica Batista", y:28 }, { x:"Mayra Agmatt", y:25 }, { x:"Juan Pereyra", y:22 }, { x:"Facundo Gimenez", y:17 }],
      ...
      "Federico Gómez": [{ x:"Mariano Artigue", y:33 }, { x:"Juan Pereyra", y:22 }, { x:"Facundo Gimenez", y:17 }, { x:"Jaquelina Polo", y:10 }, { x:"Fernando Buosi", y:10 }],
      "Gustavo Gómez": [{ x:"Monica Batista", y:28 }, { x:"Roxana Gorosito", y:17 }, { x:"Salome Rodriguez", y:8 }, { x:"Lautaro Tesi", y:7 }],
    },
    jul26: {
      "total": [{ x:"Salome Rodriguez", y:37 }, { x:"Roxana Gorosito", y:36 }, { x:"Mariano Artigue", y:22 }, { x:"Monica Batista", y:22 }, { x:"Yamila Lugo", y:19 }],
  ...
  sabores: {
    may25: {
      ...
      charts: [
        ...
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Mayo 2025', data: [{ x:"Marcelo Biurra", y:1 }, { x:"Gustavo Cabrera", y:6 }, { x:"Agustín Sbampato", y:0 }, { x:"Lucas Piarristeguy", y:1 }, { x:"Federico Morales", y:8 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:1 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    jun25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Junio 2025', data: [{ x:"Marcelo Biurra", y:0 }, { x:"Gustavo Cabrera", y:1 }, { x:"Agustín Sbampato", y:0 }, { x:"Lucas Piarristeguy", y:5 }, { x:"Federico Morales", y:3 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:2 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    jul25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Julio 2025', data: [{ x:"Marcelo Biurra", y:5 }, { x:"Gustavo Cabrera", y:3 }, { x:"Agustín Sbampato", y:0 }, { x:"Lucas Piarristeguy", y:4 }, { x:"Federico Morales", y:3 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    ago25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Agosto 2025', data: [{ x:"Marcelo Biurra", y:2 }, { x:"Gustavo Cabrera", y:2 }, { x:"Agustín Sbampato", y:0 }, { x:"Lucas Piarristeguy", y:4 }, { x:"Federico Morales", y:1 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    sep25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Septiembre 2025', data: [{ x:"Marcelo Biurra", y:3 }, { x:"Gustavo Cabrera", y:0 }, { x:"Agustín Sbampato", y:0 }, { x:"Lucas Piarristeguy", y:5 }, { x:"Federico Morales", y:3 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    oct25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Octubre 2025', data: [{ x:"Marcelo Biurra", y:5 }, { x:"Gustavo Cabrera", y:5 }, { x:"Agustín Sbampato", y:2 }, { x:"Lucas Piarristeguy", y:2 }, { x:"Federico Morales", y:3 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    nov25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Noviembre 2025', data: [{ x:"Marcelo Biurra", y:3 }, { x:"Gustavo Cabrera", y:1 }, { x:"Agustín Sbampato", y:1 }, { x:"Lucas Piarristeguy", y:1 }, { x:"Federico Morales", y:3 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    dic25: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Diciembre 2025', data: [{ x:"Marcelo Biurra", y:6 }, { x:"Gustavo Cabrera", y:9 }, { x:"Agustín Sbampato", y:7 }, { x:"Lucas Piarristeguy", y:3 }, { x:"Federico Morales", y:6 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    ene26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Enero 2026', data: [{ x:"Marcelo Biurra", y:8 }, { x:"Gustavo Cabrera", y:4 }, { x:"Agustín Sbampato", y:1 }, { x:"Lucas Piarristeguy", y:1 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:1 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    feb26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Febrero 2026', data: [{ x:"Marcelo Biurra", y:6 }, { x:"Gustavo Cabrera", y:0 }, { x:"Agustín Sbampato", y:1 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    mar26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Marzo 2026', data: [{ x:"Marcelo Biurra", y:0 }, { x:"Gustavo Cabrera", y:2 }, { x:"Agustín Sbampato", y:2 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:3 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    abr26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Abril 2026', data: [{ x:"Marcelo Biurra", y:0 }, { x:"Gustavo Cabrera", y:2 }, { x:"Agustín Sbampato", y:3 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:0 }, { x:"Lucía Vélez", y:1 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    may26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Mayo 2026', data: [{ x:"Marcelo Biurra", y:4 }, { x:"Gustavo Cabrera", y:3 }, { x:"Agustín Sbampato", y:3 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:5 }, { x:"Lucía Vélez", y:0 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    jun26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Junio 2026', data: [{ x:"Marcelo Biurra", y:3 }, { x:"Gustavo Cabrera", y:2 }, { x:"Agustín Sbampato", y:1 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:3 }, { x:"Lucía Vélez", y:1 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
    jul26: {
      kpis: [
      ...
      charts: [
        ...
        { type:'donut', title:'Distribución de altas por gerencia', sub:'Acumulado del período completo', center:"3.778", data: [{ label:"Marcelo Biurra", value:879 }, { label:"Gustavo Cabrera", value:744 }, { label:"Agustín Sbampato", value:517 }, { label:"Lucas Piarristeguy", value:447 }, { label:"Federico Morales", value:429 }, { label:"Mauro Dala Valle", value:289 }, { label:"Ivo Pisaniello", value:220 }, { label:"Lucía Vélez", value:167 }, { label:"Eliana Miguez", value:86 }], matchKind:'gerencia-total' },
        { type:'hbar', title:'Top 5 zonales con más altas', sub:'', data: [], matchKind:'top5-zonales' },
        { type:'bar', title:'No presentes por gerencia — mes activo', sub:'Cantidad de no presentes · Julio 2026', data: [{ x:"Marcelo Biurra", y:0 }, { x:"Gustavo Cabrera", y:2 }, { x:"Agustín Sbampato", y:2 }, { x:"Lucas Piarristeguy", y:0 }, { x:"Federico Morales", y:0 }, { x:"Mauro Dala Valle", y:0 }, { x:"Ivo Pisaniello", y:5 }, { x:"Lucía Vélez", y:1 }, { x:"Eliana Miguez", y:0 }], matchKind:'no-presentes-gerencia' },
      ],
    },
  },
  extremas: {
