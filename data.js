  ...
  judiciales: {
    ...
    abr: {
      ...
      charts: [
        ...
        { type:'donut',title:'Distribución por tipo (monto)', sub:'% del total', data:[{label:'Sabores',value:21.7},{label:'Otros',value:50.0},{label:'Fábrica',value:18.1},{label:'Extremas',value:10.2}] },
      ],
      details: [{
  ...
  inspecciones: {
    ...
    may: {
      ...
      details: [{
        ...
        columns:[{key:'razon',label:'RAZÓN SOCIAL'},{key:'local',label:'LOCAL'},{key:'monto',label:'MONTO',align:'right',strong:true}],
        rows:[
          {razon:'VICTORICA BARBARA ALEJANDRA',  local:'—',                    monto:'S/D'},
          {razon:'SAYAGO LEANDRO M.A.',           local:'SE - Cruce Castelar',  monto:'S/D'},
          {razon:'CASUT FRIJON MATIAS EZEQUIEL',  local:'—',                    monto:'S/D'},
          {razon:'BOLLOS Y RELLENOS',             local:'Oficina 228 Paralelo',  monto:'S/D'},
        ],
